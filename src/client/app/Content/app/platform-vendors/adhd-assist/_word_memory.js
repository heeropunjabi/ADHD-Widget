(function ($, document, window, undefined) {
    this.setSettings = function (settings) {
        ...
        localStorage.setItem('digit_span_settings', stringSettingsValue);

        return JSON.parse(stringSettingsValue);
    };
    var getSettings = function () {
        var settingsEntry = localStorage.getItem('digit_span_settings');
    ...
    this.renderCurrentRank = function (resultsContainer, results, callback) {
        ...
        immediates.shortTermMemory = overallScore;
                        ...
                        $('<button type="button">')
                            ...
                            .click(function () {
                                ...
                                for (var i = 0; i < shownSymbolsString.length; i++) {
                                    if (feedback[i] !== shownSymbolsString[i]) {
                                        errorsCount++;
                                    }
                                }
