$(function () {
    ...
    $.get((protocol+"//adhdassist.azurewebsites.net/Portal/GetSettings?settingName=focus%20hyperactivity%204"), function (data, status) {
        ...
        $('#start-test-button').removeAttr('disabled').click(function () {
            ...
            startTest('#workspace-container', '#workspace-results', '#additional-controls', function (results, immediates, newRank) {
                $.post(
                    (protocol+'//adhdassist.azurewebsites.net/Report/PersistTestResults'),
                    {
